...
/**
 * Product images â€” base64 DB depolama.
 *
 * `base64Data` tam data URL veya sadece base64 string.
 * data URL Ã¶nerilir: "data:image/jpeg;base64,/9j/4AAQ..."
 * frontend <img src={base64Data}> ile direkt gÃ¶sterebilir.
 *
 * Tip: nvarchar(max) â€” base64 string iÃ§in yeterli (10MB image â‰ˆ 13.3MB base64,
 * ama pratikte sÄ±kÄ±ÅŸtÄ±rma sonrasÄ± 200-500KB = 270-670KB string).
 */

CREATE TYPE "public"."currency" AS ENUM('TRY', 'USD', 'EUR', 'GBP');--> statement-breakpoint
...
CREATE INDEX "product_images_tenant_idx" ON "product_images" USING btree ("tenant_id");